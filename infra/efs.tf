...
resource "aws_efs_mount_target" "data" {
  for_each        = { for i, s in module.vpc.private_subnets : tostring(i) => s }
...
###################
# Attach EFS driver to EKS nodes using IRSA (IAM Roles for Service Accounts)
#This allows the EFS CSI driver running in the cluster to authenticate with AWS and manage EFS
###################
